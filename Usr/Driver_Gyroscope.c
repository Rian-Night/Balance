...
volatile ImuData_Type ImuData = {0};
volatile GyroscopeData_Type Gyroscope_EulerData = {0};
...
void Gyroscope_Solve(GyroscopeData_Type *GyroscopeData) {
    ...
    ImuData_temp[0][0] = (float) ((ImuData.gx * BMI088_GYRO_SEN) * PI / 180.0);
    ImuData_temp[0][1] = (float) ((ImuData.gy * BMI088_GYRO_SEN) * PI / 180.0);
    ImuData_temp[0][2] = (float) ((ImuData.gz * BMI088_GYRO_SEN) * PI / 180.0);
    ImuData_temp[1][0] = (float) (ImuData.ax * BMI088_ACCEL_SEN)*9.81f;
    ImuData_temp[1][1] = (float) (ImuData.ay * BMI088_ACCEL_SEN)*9.81f;
    ImuData_temp[1][2] = (float) (ImuData.az * BMI088_ACCEL_SEN)*9.81f;
#ifdef STM32F40_41xxx
